export function inputKeyboardHandle ({luigi, mario}, speed, cursors, time, delta, {marioFacing, luigiFacing, setMarioFacing, setLuigiFacing}) {
...
export function inputJoystickdHandle ({luigi, mario}, speed, cursors, time, delta, {marioFacing, luigiFacing, setMarioFacing, setLuigiFacing}) {
